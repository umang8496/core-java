...
public class CoolingController {
	...
	public void setTemperatureUpperLimit(Integer temperatureUpperLimit) {
		LOGGER.info("Setting temperature upper limit to " + temperatureUpperLimit.toString());
	...
	public void cool(Integer maxAllowedTemp) {
		LOGGER.info("Scheduled cooling with maximum allowed temperature " + maxAllowedTemp.toString());
